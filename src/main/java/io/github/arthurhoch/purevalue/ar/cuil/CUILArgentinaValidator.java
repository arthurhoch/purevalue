// File: CUILArgentinaValidator.java
...
/**
 * Validator for Argentine CUIL (Código Único de Identificación Laboral).
 * Expects 11 digits and uses the same weighting algorithm as CUIT.
 */
public final class CUILArgentinaValidator implements ValueValidator {
    ...
    public String format(String raw) {
        ...
        if (cleaned == null || cleaned.length() != 11 || !isValid(cleaned)) {
            throw new IllegalArgumentException("Invalid CUIL: " + raw);
        }
        return cleaned;
    }
}
